return {
	...
	dsc = [[Моё сознание покачивалось на мягких волнах сна, я видел разные вещи и явления. Так продолжалось долго, я не знаю сколько, но внезапно что-то поменялось...
